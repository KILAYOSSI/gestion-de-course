    ...
    <div class="col-md-10">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="index.php?controller=achats&action=ajouter" method="POST" id="achatForm">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="idMembre" name="idMembre" required>
                                ...
                                <option value="<?php echo $membre['id']; ?>"><?php echo htmlspecialchars($membre['nom_complet']); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="dateAchat" class="form-label">Date d'achat</label>
                            <input type="date" class="form-control" id="dateAchat" name="dateAchat" value="<?php echo date('Y-m-d'); ?>" required>
                        </div>
                    </div>
                        ...
                        <div class="produit-row border rounded p-3 mb-3">
                            <div class="row">
                                ...
                                <div class="col-md-2 mb-2 d-flex align-items-end">
                                    <button type="button" class="btn btn-outline-danger remove-produit" style="display: none;">
